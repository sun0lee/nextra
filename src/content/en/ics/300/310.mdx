...
81.	At the currency level, the stress scenarios stem from a  <GTooltip label="Dynamic Nelson Siegel (DNS)" desc="As described in the article Diebold, F.X. and Li C (2006).“Forecasting the Term Structure of Government Bond Yields”. Journal of Econometrics, 130, 337-364"/> modelling simplified in two ways: 
